...
(
  ...
  t.node_name,
	...
	join nav_ps_experience_track.pc_class_tree t on x.node_id = t.node_id
	where d.osat is not null
	and t.id_model = 75910
	and t.node_id > 0
	group by t.node_id,
  t.node_name,
	t.parent_id
